...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Por Aprovar',
            'url'  => 'requisition-management/pending',
        ...
        [
            'text' => 'Por Entregar',
            'url'  => 'requisition-management/deliver',
            'icon' => 'fas fa-pause-circle',
            'icon_color' => 'orange',
            'can'  => ['tech-permission', 'admin-permission'],
        ],
        [
            'text' => 'Em Empréstimo',
            'url'  => 'requisition-management/active',
            'icon' => 'fas fa-play-circle',
            'icon_color' => 'green',
            'can'  => ['tech-permission', 'admin-permission'],
        ],
        [
            'text' => 'Fechadas',
            'url'  => 'requisition-management/closed',
            'icon' => 'fas fa-stop-circle',
            'icon_color' => 'red',
            'can'  => ['tech-permission', 'admin-permission'],
        ],
