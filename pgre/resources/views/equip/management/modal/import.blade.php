<div class="modal fade" id="import_equipments">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form method="POST" action="{{url('/equip-management/equipments/excel-import')}}" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title">Importar Equipamentos</h5>
                ...
                <div class="modal-footer">
                    <a href="/equip-management/equipments/import-template" class="btn btn-info btn-flat"><i class="fas fa-lg fa-file-excel"></i> Template</a>
