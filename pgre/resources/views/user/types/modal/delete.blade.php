<div class="modal fade" id="delete_user_type_{{$user_type->id}}">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{url('/user-management/types/' . $user_type->id)}}" method="POST" style="display: inline-block";>
                @csrf
                @method('DELETE')
                <div class="modal-header">
                    <h5 class="modal-title">Eliminar tipo de utilizador </h5>
