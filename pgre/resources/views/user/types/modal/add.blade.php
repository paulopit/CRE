<div class="modal fade" id="add_user_type">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form method="POST" action="{{url('/user-management/types/add')}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="modal-body">
                    <x-adminlte-input name="type_name" label="" placeholder="Tipo Utilizador" value="" fgroup-class="col-md-12">
